namespace DesafioFundamentos.Models
{
    public class Estacionamento
    {
        ...
        private bool VerificaSeJaExiste(string placa){
            return this.veiculos.Any(x => x.ToUpper() == placa.ToUpper());
        }
        ...
        public void AdicionarVeiculo()
        {
            ...
            Console.WriteLine($"Veículo de placa {placa} foi cadastrado");
        }
